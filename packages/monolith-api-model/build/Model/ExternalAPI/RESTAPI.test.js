...
describe('REST APIs Caller Test Suite', () => {
    ...
    describe('GET method', () => {
        ...
        it('should be fulfilled', () => expect(RestApi.get(okUrl)).to.be.fulfilled);

        it('should be rejected', () => expect(RestApi.get(errorUrl)).to.be.rejected);
    });
    ...
    describe('POST method', () => {
        ...
        it('should be successful', () => expect(RestApi.post(okUrl)).to.be.fulfilled);

        it('should be rejected', () => expect(RestApi.post(errorUrl)).to.be.rejected);
    });
    ...
    describe('PUT method', () => {
        ...
        it('should be successful', () => expect(RestApi.put(okUrl)).to.be.fulfilled);

        it('should be rejected', () => expect(RestApi.put(errorUrl)).to.be.rejected);
    });
    ...
    describe('DELETE method', () => {
        ...
        it('should be successful', () => expect(RestApi.delete(okUrl)).to.be.fulfilled);

        it('should be rejected', () => expect(RestApi.delete(errorUrl)).to.be.rejected);
    });
});